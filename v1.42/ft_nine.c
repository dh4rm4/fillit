...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/04/29 13:07:22 by kboddez           #+#    #+#             */
/*   Updated: 2016/04/29 15:41:36 by kboddez          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
**	PLACES IF POSSIBLE THE TETRNIOS No'9 INTO 'tab'
*/

int	ft_nine(t_point co, t_inv *move, char (*tab)[SIZE], char (*end)[SIZE])
{
