...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/04/29 13:04:39 by kboddez           #+#    #+#             */
/*   Updated: 2016/04/29 15:41:02 by kboddez          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
**	PLACES IF POSSIBLE THE TETRNIOS No'6 INTO 'tab'
*/

int	ft_six(t_point co, t_inv *move, char (*tab)[SIZE], char (*end)[SIZE])
{
