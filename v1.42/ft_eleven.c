...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/04/29 13:09:16 by kboddez           #+#    #+#             */
/*   Updated: 2016/04/29 15:41:53 by kboddez          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
**	PLACES IF POSSIBLE THE TETRNIOS No'11 INTO 'tab'
*/

int	ft_eleven(t_point co, t_inv *move, char (*tab)[SIZE], char (*end)[SIZE])
{
