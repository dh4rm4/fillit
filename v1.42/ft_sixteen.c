...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/04/29 13:13:25 by kboddez           #+#    #+#             */
/*   Updated: 2016/04/29 15:42:43 by kboddez          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
**	PLACES IF POSSIBLE THE TETRNIOS No'16 INTO 'tab'
*/

int	ft_sixteen(t_point co, t_inv *move, char (*tab)[SIZE], char (*end)[SIZE])
{
